...
#### Detections vs vegetation survey data
    ...
    ## [1] Creation Date:  Thu Sep  8 12:05:05 2022
    ## [1] 
    ## [1] Name:  gdm_01
    ## [1] 
    ## [1] Data:  gdmTab
...
![](output/readme-unnamed-chunk-5-1.png)<!-- -->![](output/readme-unnamed-chunk-5-2.png)<!-- -->![](output/readme-unnamed-chunk-5-3.png)<!-- -->
...
Fit a GDM using the satellite data:
    ...
    ## [1] 
    ## [1] GDM Modelling Summary
    ## [1] Creation Date:  Thu Sep  8 12:05:10 2022
    ## [1] 
    ## [1] Name:  gdm.rast
    ## [1] 
    ## [1] Data:  gdmTab.rast
...
![](output/readme-unnamed-chunk-7-1.png)<!-- -->

![](output/readme-unnamed-chunk-8-1.png)<!-- -->![](output/readme-unnamed-chunk-8-2.png)<!-- -->
...
![](output/readme-unnamed-chunk-8-3.png)<!-- -->
